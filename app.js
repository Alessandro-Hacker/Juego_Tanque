...
game = {
    ...
    colorEnemigo:["reed","blue","black","white","yellow","pink","purple"],
    colorBala:"red",
    centroX:0,
    centroY:0,
    w:0,
...
const botonInicio = () => {
    ...
    if (!boton) {
        ...
        boton.id = "boton-inicio";
        boton.innerText = "Inicio";
        // Cuando se haga clic en el botón, iniciar el juego
        boton.addEventListener("click", () => {
            seleccionar();
        });

        document.getElementById("contenedor-canvas").appendChild(boton);
    }
    boton.style.display = "block";
};

const ocultarBotonInicio = () => {
